    ...
    constructor(
        ...
        super(
            ud.map((ud) => {
                ...
                if (ud.home) {
                    panToHome = new SubtleButton(Svg.home_svg().SetClass("dark:invert"), t.moveToHome, {
                        imgSize,
                    }).onClick(() => {
                        const home = ud?.home
                        if (home === undefined) {
                ...
                return new Combine([
                    ...
                    ...settingElements,
                    new SubtleButton(
                        Svg.envelope_svg().SetClass("dark:invert"),
                        new Combine([
                            t.gotoInbox,
                            ud.unreadMessages == 0
                                ? undefined
                    ...
                    new SubtleButton(Svg.gear_svg().SetClass("dark:invert"), t.gotoSettings, {
                        imgSize,
                    ...
                    new SubtleButton(Svg.logout_svg().SetClass("dark:invert"), Translations.t.general.logout, {
                        imgSize,
                    }).onClick(() => {
